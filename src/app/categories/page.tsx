        ...
        <div className="container mx-auto px-4 py-8">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
              Find the perfect business for your needs from our carefully
              curated categories
            </p>
          ...
          <div className="mt-16 text-center">
            <div className="glass p-8 rounded-2xl border-0 shadow-modern-lg max-w-2xl mx-auto">
              ...
              <p className="text-muted-foreground mb-6">
                Join thousands of businesses already listed on Director Value
                and reach new customers today.
              </p>
              <div className="flex flex-col sm:flex-row justify-center gap-4">
                <Link href="/pricing">
                  <Button size="lg" className="gradient-primary">
